...
**Автор: Sava**
Описание
	SavaLED_ESP32 — это мощная, эффективная и полностью неблокирующая библиотека для платформы ESP32 (в среде Arduino IDE), предназначенная для управления адресными светодиодами (WS2812, SK6812 и совместимыми).</br>
